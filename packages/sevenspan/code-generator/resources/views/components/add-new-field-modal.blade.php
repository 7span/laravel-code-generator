        ...
        <x-slot:closebtn>
            ...
            <div class="mt-4 space-y-4">
                ...
                <div>
                    ...
                    <select class="form-control w-full border rounded-md p-2"
                    wire:model.live="column_validation" id="column_validation"
                ...
                <div>
                    <div class="flex items-center">
                        <span class="mr-2">Do you want to add Scope?</span>
                            <input type="checkbox" wire:model.live="add_scope" name="option" value="yes"
                                class="form-radio text-orange-500" checked>
                      <!--  <label class="inline-flex items-center">
                            <input type="radio" wire:model.live="add_scope" name="option" value="no"
