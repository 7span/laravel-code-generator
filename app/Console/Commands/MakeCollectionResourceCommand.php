...
class MakeCollectionResourceCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:collection_resource {name}';
     ...
     * @var string
     */
    protected $description = 'Make resource collection file';
