...
@section('content')
    <form id="makeMutationFileForm">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control container" id="queryText" name="mutation_text" rows="3" cols="50"
        ...
        $('#makeMutationFileForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(response) {
                    ...
                    (typeof response.responseJSON.format != undefined) ? $('.mutationFormatError').text(
