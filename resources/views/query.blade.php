...
@section('content')
    <br>
    <b><span style="color:red">Please enter either whole Query object to the left side OR enter Query name and Query text in
            the right side to generate the Type file.</span></b>
        ...
        $('#makeQueryFileForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(response) {
                    ...
                    response.responseJSON.hasOwnProperty('model_name') ? $('.modelNameError').text(
                        response.responseJSON.model_name[0]) : '';
