<form id="makeFileForm">
  ...
  <br><br>
    ...
    <fieldset>
      ...
      <input type="hidden" name="request" value="0" checked="checked">
      <input type="checkbox" id="laraveldata" name="laraveldata" value="1" @checked(old('request') ?? 'checked')><label class="light" for="request"> Do you want laravel data file?</label><br>
